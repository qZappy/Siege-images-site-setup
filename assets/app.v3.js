...
(function(){
  ...
  function openViewer(src){
    ...
    // Ensure sidebar is hidden while viewing
  ...
  closeBtn.addEventListener('click', ()=>{
    ...
    // Restore sidebar previous state
  ...
  document.addEventListener('click', (e)=>{
    ...
    if(a){ e.preventDefault(); document.getElementById('helpPanel').style.display = document.getElementById('helpPanel').style.display ? '' : 'block'; }
  });
